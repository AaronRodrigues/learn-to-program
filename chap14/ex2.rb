...
# Hint: You can use  Time.now.hour to get the current hour. However, this
# returns a number between 0 and 23, so you will have to alter those numbers in
# order to get ordinary clock-face numbers (1 to 12).
